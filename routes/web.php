...
Route::get('/user-login', fn () => auth()->check() ? redirect()->route('user.dashboard') : view('users.login'))->name('user.login');
Route::get('/user-register', fn () => auth()->check() ? redirect()->route('user.dashboard') : view('users.register'))->name('user.register');
// Default register routes (custom implementation)
Route::get('/register', fn () => auth()->check() ? redirect()->route('user.dashboard') : view('users.register'))->name('register');
...
Route::middleware('admin.auth')->group(function () {
    ...
    Route::post('admin/funds/{id}/decline',                     [FundsController::class, 'decline'])->name('admin.funds.decline');
