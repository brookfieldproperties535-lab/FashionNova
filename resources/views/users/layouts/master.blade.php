...
<head>
    ...
    <!-- ===============================================--><!--    Document Title--><!-- ===============================================-->
    <title>Fashion Nova | Premium Fashion & Style</title>
    ...
    <!-- ===============================================--><!--    Stylesheets--><!-- ===============================================-->
    <link href="{{ asset('user/vendors/loaders.css/loaders.min.css') }}" rel="stylesheet" type="text/css">
  ...
  <body class="overflow-hidden-x">
    ...
    <nav class="fancynavbar fancynavbar-expand-lg" data-zanim-lg='{"from":{"opacity":1,"x":70},"to":{"opacity":1,"x":0},"ease":"CubicBezier","duration":0.8,"delay":0.3}' data-zanim-xs='{"from":{"opacity":1,"y":-37},"to":{"opacity":1,"y":0},"ease":"CubicBezier","duration":0.8,"delay":0.3}' data-zanim-trigger="scroll" data-exclusive="true">
      <div class="fancynavbar-togglerbar" data-onscroll-fade-in="data-onscroll-fade-in">
        <a class="fancynavbar-brand" href="{{ route('users.home') }}">
          <img class="fancynavbar-brand-img" src="{{ asset('user/assets/img/logo/02.png') }}" alt="Logo" width="30" height="30" data-zanim-lg='{"from":{"opacity":0,"x":45},"to":{"opacity":1,"x":0},"ease":"CubicBezier","duration":0.8,"delay":0.4}' data-zanim-trigger="scroll" />
        </a>
        ...
        <div class="fancynavbar-addon fancynavbar-addon-height" data-zanim-lg='{"from":{"opacity":1,"x":45},"to":{"opacity":1,"x":0},"ease":"CubicBezier","duration":0.8,"delay":0.4}' data-zanim-trigger="scroll">
          @auth
            <span class="fancynavbar-addon-item font-secondary ls fw-black fs-10 d-block text-white">
              {{ strtoupper(substr(auth()->user()->name, 0, 2)) }}
            </span>
          @else
            <a class="fancynavbar-addon-item" href="{{ route('user.login') }}">
      ...
      <div class="fancynavbar-collapse">
        <ul class="fancynavbar-nav">
            ...
            <a class="fancynav-link" href="{{ route('user.dashboard') }}">
              <span class="fancynav-link-content">Dashboard</span>
            </a>
          </li>

          <li class="fancynav-item">
            <a class="fancynav-link" href="{{ route('users.about') }}">
              <span class="fancynav-link-content">About Us</span>
            </a>
          </li>

          <li class="fancynav-item">
            <a class="fancynav-link" href="{{ route('users.privacy') }}">
              <span class="fancynav-link-content">Privacy Policy</span>
            </a>
          </li>

          <li class="fancynav-item">
            <a class="fancynav-link" href="{{ route('user.terms') }}">
              <span class="fancynav-link-content">Terms</span>
            </a>
          </li>

          @guest
            <li class="fancynav-item">
              <a class="fancynav-link" href="{{ route('user.login') }}">
                <span class="fancynav-link-content">Login</span>
              </a>
            </li>
            <li class="fancynav-item ps-5 mt-2 mb-2">
              <a class="btn btn-sm btn-outline-light font-secondary fw-black ls text-uppercase" href="{{ route('register') }}">Get Started</a>
            </li>
          @endguest
          ...
          @auth
            <li class="fancynav-item fancy-dropdown">
              <a class="fancynav-link fancy-dropdown-toggle" href="JavaScript:void(0)">
                <span class="fancynav-link-content">{{ auth()->user()->name }}</span>
              </a>
              <div class="fancy-dropdown-menu">
                <div class="row pb-4 pt-3">
                  <div class="col-auto ps-2">
                    <a class="fancy-dropdown-item" href="{{ route('user.profile') }}">Profile</a>
                    <a class="fancy-dropdown-item" href="{{ route('user.wallet') }}">Wallet</a>
                    <a class="fancy-dropdown-item" href="{{ route('user.recharge') }}">Deposit</a>
                    <a class="fancy-dropdown-item" href="{{ route('user.dashboard') }}">Analytics</a>
                    <a class="fancy-dropdown-item" href="{{ route('user.dashboard') }}">Start Evaluation</a>
                    <a class="fancy-dropdown-item" href="{{ route('user.tasks') }}">Evaluation History</a>
                    <a class="fancy-dropdown-item" href="{{ route('user.redemption') }}">Withdrawal</a>
                    <a class="fancy-dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('nav-logout-form').submit();">Logout</a>
    ...
    <!--===============================================--><!--    Modal for language selection--><!--===============================================--><!-- Modal-->
          ...
          <div class="modal-content bg-black">
            <div class="modal-body text-center p-0"><button class="btn-close text-white position-absolute top-0 end-0 times-icon mt-2 me-2 p-0" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
              <ul class="list-unstyled my-0 py-4 font-secondary">
                <li><a class="text-white fw-bold pt-1 d-block" href="default.html">English</a></li>
                <li><a class="pt-1 d-block text-body-tertiary" href="#!">Français</a></li>
                <li><a class="text-body-tertiary pt-1 d-block" href="#">عربى</a></li>
    ...
    <script src="{{ asset('user/vendors/anchorjs/anchor.min.js') }}"></script>
    <script src="{{ asset('user/vendors/is/is.min.js') }}"></script>
    <script src="{{ asset('user/vendors/bigpicture/BigPicture.js') }}"> </script>
    <script src="{{ asset('user/vendors/rellax/rellax.min.js') }}"> </script>
    <script src="{{ asset('user/vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ asset('user/vendors/lodash/lodash.min.js') }}"></script>
    <script src="{{ asset('user/vendors/imagesloaded/imagesloaded.pkgd.js') }}"></script>
    <script src="{{ asset('user/vendors/gsap/gsap.js') }}"></script>
    <script src="{{ asset('user/vendors/gsap/customEase.js') }}"></script>
    <script src="{{ asset('user/vendors/gsap/drawSVGPlugin.js') }}"></script><!-- Global site tag (gtag.js) - Google Analytics-->
...
<noscript><a href="https://www.livechat.com/chat-with/19884450/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a></noscript>
