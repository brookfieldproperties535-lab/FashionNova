  ...
  <section class="py-6">
    <div class="container">
      ...
      <div class="text-center mb-4"
        ...
        <h5 class="text-uppercase ls fw-black font-secondary">Withdrawal History</h5>
      </div>
      ...
      <div class="row g-3 mb-4"
        ...
        <div class="col-4">
          <div class="border rounded p-3 text-center">
            ...
            <span class="fw-bold font-secondary">$ {{ number_format($totalWithdrawn, 2) }}</span>
          </div>
        </div>
        <div class="col-4">
          <div class="border rounded p-3 text-center">
      ...
      <div class="border rounded"
        ...
        <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
          <h6 class="fw-bold font-secondary mb-0">Withdrawal Records</h6>
            ...
            <tbody>
              @forelse ($redemptionHistory as $r)
                ...
                <tr class="border-bottom">
                  <td class="ps-3 font-secondary fs-10">Debit</td>
                  ...
                  <td>
                    @if ($status === 'active')
                      <span class="badge rounded-pill font-secondary fs-10 px-2 py-1"
                        style="background:rgba(13,110,253,0.1);color:#0d6efd;">Paid</span>
              ...
              @empty
                <tr>
                  <td colspan="4" class="text-center py-5">
                    ...
                    <p class="font-secondary fs-10 text-body-tertiary mb-0">No withdrawal records yet.</p>
                  </td>
                </tr>
              @endforelse
            </tbody>
